...
file[j].ereceipt = response2.data;
}
console.log(j + '.. ');
do {;} while (Date.now() % 100 > 20);
}
document.head.innerHTML = '';
document.body.innerHTML = '<br><br>This is your list of transactions and eReceipts (in json): <br>(copy-paste and save to a plain text file)<br><textarea id="List" rows="50" cols="100">' + JSON.stringify(file);
